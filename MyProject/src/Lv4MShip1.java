 ...
 */
public class Lv4MShip1 extends GameObject
{
	...
	public Lv4MShip1()
	{
		super("Lv4MShip", 200, 200, "mothership.png");
		PlayerShip.numEnemies++;
		setCircleCollider(50);
		PlayerShip.MShipHealth2 = 3;
		System.out.println(PlayerShip.numEnemies + "mship1");
	}

	@Override
	public void update(float dt)
	{
		if (PlayerShip.MShipHealth2 <= 0)
		{
			kill();
			PlayerShip.numEnemies--;
		}
