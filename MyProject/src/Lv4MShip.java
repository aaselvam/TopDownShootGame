 ...
 */
public class Lv4MShip extends GameObject
{
	...
	public Lv4MShip()
	{
		...
		PlayerShip.MShipHealth3 = 3;
		System.out.println(PlayerShip.numEnemies + "mship");
	}

	@Override
	public void update(float dt)
	{
		if (PlayerShip.MShipHealth3 <= 0)
		{
			kill();
			PlayerShip.numEnemies--;
		}
